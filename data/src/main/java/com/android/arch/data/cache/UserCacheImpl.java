 ...
 */
package com.android.arch.data.cache;
...
import com.android.arch.data.cache.serializer.Serializer;
import com.android.arch.data.entity.UserEntity;
import com.android.arch.data.exception.UserNotFoundException;
 ...
 */
@Singleton
public class UserCacheImpl implements UserCache<UserEntity> {

    private static final String SETTINGS_FILE_NAME = "com.android.mvpdagger.clean.SETTINGS";
    ...
    private RoomDB initDB(Context context) {
