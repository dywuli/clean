...
import com.android.arch.data.entity.mapper.UserEntityJsonMapper;
import com.android.arch.data.net.RestApi;
import com.android.arch.data.net.RestApiImpl;
...
public class UserDataStoreFactory {
  ...
  public DBUserDataStore createDBStore() {
    return new DBUserDataStore(this.userCache);
  }
}
