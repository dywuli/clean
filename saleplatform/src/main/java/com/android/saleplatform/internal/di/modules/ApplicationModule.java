 ...
 */
package com.android.saleplatform.internal.di.modules;

import android.content.Context;

import com.android.arch.data.cache.UserCache;
import com.android.arch.data.cache.UserCacheImpl;
import com.android.arch.data.executor.JobExecutor;
...
import com.android.saleplatform.UIThread;
...
public class ApplicationModule {
  ...
  @Provides @Singleton
  UserDao provideUserDaoRepository(UserDataRepository userDataRepository) {
    return userDataRepository;
  }
  @Provides @Singleton
  GoodsDao provideGoodsRepository(UserDataRepository userDataRepository) {
    return userDataRepository;
  }
  @Provides @Singleton
  AddressDao provideAddressRepository(UserDataRepository userDataRepository) {
    return userDataRepository;
  }
}
