...
public abstract class BaseNiceDialog extends DialogFragment {
    ...
    @StyleRes
    protected int theme = R.style.CustomNiceDialogStyle; // dialog主题
    @StyleRes
        ...
        if (window != null) {
            ...
            switch (gravity) {
                ...
                case (Gravity.LEFT | Gravity.TOP):
                    if (animStyle == 0) {
                        animStyle = com.shehuan.nicedialog.R.style.LeftAnimation;
                    }
                    break;
                case Gravity.TOP:
                    if (animStyle == 0) {
                        animStyle = com.shehuan.nicedialog.R.style.TopAnimation;
                    }
                    break;
                case Gravity.RIGHT:
                ...
                case (Gravity.RIGHT | Gravity.TOP):
                    if (animStyle == 0) {
                        animStyle = com.shehuan.nicedialog.R.style.RightAnimation;
                    }
                    break;
                case Gravity.BOTTOM:
                    if (animStyle == 0) {
                        animStyle = com.shehuan.nicedialog.R.style.BottomAnimation;
                    }
                    break;
                default:
                    break;
